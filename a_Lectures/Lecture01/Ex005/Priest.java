...
public class Priest {
    ...
    public Priest() {
        this(String.format(HERO_PRIEST_D, ++Priest_6.number),
        Priest_6.r.nextInt(100, 200),
        Priest_6.r.nextInt(50, 150));
    }

    public int Attack() {
        int damage = Priest_6.r.nextInt(20, 30);
